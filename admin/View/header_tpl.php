<?php
      $row_lienhe  =  $db->row("SELECT COUNT(*) as num FROM #_contact where view<>1 ");
      $tong_count = 0;

      if($config['setup']['cart']=='true'){
          $row_giohang  =  $db->row("SELECT COUNT(*) as num FROM #_order where view<>1");
...
<div class="wrapper">
    ...
    <div class="userNav">
        <ul>
            ...
            <?php } ?>
            <li><a href="<?=$config['config_base']?>" title="" target="_blank"><img src="Assets/images/icons/topnav/mainWebsite.png" alt="" /><span>Vào trang web</span></a></li>
