...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
        <input type="button" class="blueB" value="Xoá" onclick="ChangeAction('index.html?com=order&act=man&multi=del');return false;" />
    </div>  
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center" style="color:<?=$arr_color[$items[$i]['trangthai']]?>; font-weight:bold" <?php if($items[$i]['view']==0){ echo "style='font-weight:bold;'";}?>>
          <?=$func->getname('title',$items[$i]['trangthai'])?>
        </td>
       
        <td class="actBtns">
            <a href="export_word.php?id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Xuất đơn hàng word">
            <img src="Assets/images/icons/dark/word.png" alt="">
            </a>
            <a href="export.php?id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Xuất đơn hàng excel"><img src="Assets/images/icons/dark/excel.png" alt=""></a>
            ...
            <a href="" onclick="CheckDelete('index.html?com=order&act=delete&id=<?=$items[$i]['id']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa đơn hàng"><img src="Assets/images/icons/dark/close.png" alt=""></a>        </td>
      </tr>
         <?php } ?>
                </tbody>
  </table>
