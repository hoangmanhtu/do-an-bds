...
<form name="supplier" id="validate" class="form" action="index.html?com=project&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow ">
			...
			<div class="formRight">
                <input type="text" name="slug" title="Nhập slug" id="slug" class="tipS " value="<?=@$item['slug']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			<label>Tọa độ</label>
			<div class="formRight">
                <input type="text" name="toado" title="Nhập tên tọa độ google map" id="toado" class="tipS validate[required]" value="<?=@$item['toado']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<ul>
				...
				<li><a href="#tab_2">Vị trí</a></li>
				<li><a href="#tab_3">Tiện ích</a></li>
				<li><a href="#tab_7">Mặt bằng</a></li>
				<li><a href="#tab_4">Nhà mẫu</a></li>
				<li><a href="#tab_5">Pháp lý</a></li>
				<!-- <li><a href="#tab_6">Ưu đãi</a></li> -->
				<li><a href="#tab_8">PT Thanh toán</a></li>
		</ul>
		</div>
		<div id="show_tabs">
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="4" cols="" title="Nội dung header" class="tipS" name="code_more"><?=@$item['code_more']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
