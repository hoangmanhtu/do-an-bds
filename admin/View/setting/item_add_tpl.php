...
<form name="supplier" id="validate" class="form" action="index.html?com=setting&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
    ...
    <div class="widget">
		...
		<div class="formRow w50 lang_hidden lang_<?=$key?> <?php if($config['activelang']==$key){ echo "active";}?>">
			<label>Slogan</label>
			<div class="formRight">
                <input type="text" name="slogan_<?=$key?>" title="Nhập slogan (<?=$value?>)" id="slogan_<?=$key?>" class="tipS validate[required]" value="<?=@$item['slogan_'.$key]?>" />
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
		...
		<div class="formRow w50">
			<label>Tư vấn</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['consult_phone']?>" name="consult_phone" title="Nhập số điện thoại" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow w50">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['location_map']?>" name="location_map" title="Nhập tọa độ vị trí công ty" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
		...
		<div class="formRow w50">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['keymap']?>" name="keymap" title="Key map google" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow w50">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['giayphep']?>" name="giayphep" title="Nhập giấy phép kinh doanh" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow w50">
			<label>Nơi Cấp</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['noicap']?>" name="noicap" title="Nhập nơi cấp" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
