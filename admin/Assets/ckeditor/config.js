...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'lineheight,wenzgmap,youtube,googledocs,tableresize,imagerotate,youtube,entities,bootstrapVisibility,slideshow,locationmap,pastefromword,lightbox,imagebrowser,imagepaste,quicktable,widget,widgetbootstrap,widgettemplatemenu,contextmenu,menu,fontawesome,templates';
