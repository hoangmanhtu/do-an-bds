	...
	<ul class="ul">
		<li>
			<a href="javascript:callme('tel:<?=$row_setting['hotline']?>')" title="title">
				<img src="Assets/images/icon/icon-t1.png" alt="images"><br>
				<span><?=_goidien?></span>
			</a>
		</li>
		<li>
			<a href="javascript:callme('sms:<?=$row_setting['hotline']?>')" title="title">
				<img src="Assets/images/icon/icon-t2.png" alt="images"><br>
				<span><?=_nhantin?></span>
			</a>
		</li>
		<li>
			<a href="javascript:callme('https://zalo.me/<?=$row_setting['zalo']?>')" title="title">
				<img src="Assets/images/icon/icon-t3.png" alt="images"><br>
				<span>Chat zalo</span>
			</a>
		</li>
		<li>
			<a href="javascript:callme('<?=$row_setting['facebook']?>')" title="title">
				<img src="Assets/images/icon/icon-t4.png" alt="images"><br>
				<span>Chat</span>
			</a>
		</li>
	</ul>
